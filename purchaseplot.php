...
<body>
<form id="form1" name="form1" method="post" action="pplot_exe.php" enctype="multipart/form-data">
  <table width="345" height="142" border="0" align="center">
    <tr>
      <td width="154" bgcolor="#CCCCCC"> First Name </td>
      <td width="181"><label>
    ...
    <tr>
      <td bgcolor="#CCCCCC">Plot <span class="style6"><span class="style7">  no</span></span></td>
    ...
    <tr>
      ...
      <td class="style7"><select name="st" id="st">
        <?php 
		$no = 1;
		for(; $no<=2000; $no++)
		{?>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      <td bgcolor="#CCCCCC"><span class="style6 style7"> Price</span></td>
      <td bgcolor="#009999"><span class="style7">
        <input name="price" size="28" type="text" id="price"/>
      </span></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      <td bgcolor="#CCCCCC"><span class="style6 style7">Plot Condition</span></td>
      <td bgcolor="#009999"><span class="style7">
        <input name="pcon" size="28" type="text" id="pcon"/>
      </span></td>
    </tr>
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      <td bgcolor="#CCCCCC"><span class="style6 style7">Scheme</span></td>
      <td bgcolor="#009999"><label>
        <select name="scheme" id="scheme">
          <option value="feghf">feghf</option>
    ...
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      <td bgcolor="#CCCCCC"><span class="style6 style7">Description</span></td>
      <td bgcolor="#009999"><span class="style7">
        <input name="des" size="28" type="text" id="des"/>
      </span></td>
    </tr>
    <tr>
      <td bgcolor="#CCCCCC"><span class="style6 style7">Picture</span></td>
      <td bgcolor="#009999"><input name="file" type="file" size="28" /></td>
    </tr>
    <tr>
